      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 content">
            <h1>the diagnosis of the disease</h1>
            <h5>
              If your doctor suspects you have cirrhosis, one or more of the
              following imaging tests may be performed:
            </h5>
            <ul>
              <li>Abdominal computed tomography (CT) scan</li>
              <li>Abdominal ultrasound</li>
              <li>Elastography</li>
              <li>Body magnetic resonance imaging (MRI)</li>
              <li>Magnetic resonance cholangiopancreatography (MRCP)</li>
            </ul>
          </div>
          <div class="col-md-6 image">
            <img src="res/img/Team_small-2.png" alt="" />
          </div>
        </div>
      </div>
    </section>
