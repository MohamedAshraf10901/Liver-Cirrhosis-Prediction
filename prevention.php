      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 content">
            <h1>Disease prevention</h1>
            <h5>
              Reduce your risk of cirrhosis by taking these steps to care for your
              liver:
            </h5>
            <ul>
              <li>Do not drink alcohol if you have cirrhosis.</li>
              <li>Eat a healthy diet.</li>
              <li>Maintain a healthy weight.</li>
              <li>Reduce your risk of hepatitis.</li>
            </ul>
          </div>
          <div class="col-md-6 image">
            <img src="res/img/prevention.png" alt="" />
          </div>
        </div>
      </div>
    </section>
