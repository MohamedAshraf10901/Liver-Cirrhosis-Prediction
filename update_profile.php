<?php
    ...
    if(isset($_POST['admin_register'])){
        ...
        if(!$email_error && !$password_error){
          ...
          database_update_admin($name, $address, $phone_number, $email, $password, $confirm_password, $birth_date, $gender, $admin_id );
    ...
    <div class="signin">
      <div class="container">
        <form action="admin_signUp.php" method="post">
          <div class="row">
            <h4 class="headCreate">Update Admin Profile</h4>
          ...
          <div class="row">
            <div class="input-group">
              <button type="submit" name="admin_register" class="button loginBtn">Update <i class="fa-solid fa-arrow-right-to-bracket"></i></button>
            </div>
          </div>
        </form>
      </div>
