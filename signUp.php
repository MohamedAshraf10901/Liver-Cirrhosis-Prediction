<?php
    ...
    if(isset($_POST['submit_register'])){
        ...
        if(!$email_error && !$password_error){
          $id = database_insert_patient($name, $address, $phone_number, $email , $password , $confirm_password , $birth_date , $gender);
    ...
    <div class="signin">
      <div class="container">
        <form action="signUp.php" method="post">
          <div class="row">
            <h4 class="headCreate">Create Account</h4>
          ...
          <div class="row">
            <div class="input-group">
              <button type="submit" name="submit_register" class="button loginBtn">Signup <i class="fa-solid fa-arrow-right-to-bracket"></i></button>
            </div>
          </div>
        </form>
      </div>
