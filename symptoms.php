        ...
        <div class="row align-items-center">
          <div class="col-md-6 content">
            ...
            <ul>
              ...
              <li>Nausea</li>
              <li>Swelling in your legs, feet or ankles (edema)</li>
              <li>Weight loss</li>
              <li>Itchy skin</li>
              <li>Yellow discoloration in the skin and eyes (jaundice)</li>
              <li>Fluid accumulation in your abdomen (ascites)</li>
          ...
          <div class="col-md-6 image">
            <img src="res/img/Landing-symptom-management.png" alt="" />
          </div>
        </div>
      </div>
    </section>
